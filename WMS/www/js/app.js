    ...
    function (
        ...
        $ionicPlatform.ready( function () {
            ...
            SqlService.Init().then(function(res){
                ...
                SqlService.Drop( 'Tjms2' ).then( function ( res ) {
                    SqlService.Create( 'Tjms2', TABLE_DB.Tjms2 ).then( function ( res ) {
                    } );
                } );
...
app.config( [ '$httpProvider', '$stateProvider', '$urlRouterProvider', '$ionicConfigProvider',
    function ( $httpProvider, $stateProvider, $urlRouterProvider, $ionicConfigProvider) {
        ...
        $stateProvider
            ...
            .state( 'grUpdateTjms5', {
                url: '/gr/updatetjms5/:TrxNo/:LineItemNo',
                cache: 'false',
                templateUrl: 'view/GoodsReceipt/updatetjms5.html',
                controller: 'grUpdateTjms5Ctrl'
            } )
